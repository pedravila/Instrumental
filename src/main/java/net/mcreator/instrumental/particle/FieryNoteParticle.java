...
package net.mcreator.instrumental.particle;
...
public class FieryNoteParticle extends InstrumentalModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public FieryNoteParticle(InstrumentalModElements instance) {
		super(instance, 317);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("fiery_note"));
	}

...
public class IronNoteParticle extends InstrumentalModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public IronNoteParticle(InstrumentalModElements instance) {
		super(instance, 184);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("iron_note"));
	}

...
public class RedDanceFloorBlock extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:red_dance_floor")
	public static final Block block = null;
	public RedDanceFloorBlock(InstrumentalModElements instance) {
		super(instance, 94);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_dance_floor");
		}

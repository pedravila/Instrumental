...
public class BlackDanceFloorBlock extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:black_dance_floor")
	public static final Block block = null;
	public BlackDanceFloorBlock(InstrumentalModElements instance) {
		super(instance, 95);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_dance_floor");
		}

...
public class BrownDanceFloorBlock extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:brown_dance_floor")
	public static final Block block = null;
	public BrownDanceFloorBlock(InstrumentalModElements instance) {
		super(instance, 101);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brown_dance_floor");
		}

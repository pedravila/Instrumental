...
public class OrangeDanceFloorBlock extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:orange_dance_floor")
	public static final Block block = null;
	public OrangeDanceFloorBlock(InstrumentalModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_dance_floor");
		}

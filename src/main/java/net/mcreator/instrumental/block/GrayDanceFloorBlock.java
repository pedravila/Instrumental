...
public class GrayDanceFloorBlock extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:gray_dance_floor")
	public static final Block block = null;
	public GrayDanceFloorBlock(InstrumentalModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gray_dance_floor");
		}

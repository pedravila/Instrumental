...
public class LightBlueDanceFloorBlock extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:light_blue_dance_floor")
	public static final Block block = null;
	public LightBlueDanceFloorBlock(InstrumentalModElements instance) {
		super(instance, 264);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("light_blue_dance_floor");
		}

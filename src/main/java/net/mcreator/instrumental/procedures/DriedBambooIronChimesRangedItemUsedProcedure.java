...
public class DriedBambooIronChimesRangedItemUsedProcedure extends InstrumentalModElements.ModElement {
	public DriedBambooIronChimesRangedItemUsedProcedure(InstrumentalModElements instance) {
		super(instance, 211);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				InstrumentalMod.LOGGER.warn("Failed to load dependency entity for procedure DriedBambooIronChimesRangedItemUsed!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				InstrumentalMod.LOGGER.warn("Failed to load dependency itemstack for procedure DriedBambooIronChimesRangedItemUsed!");
			return;
		}

...
public class InspirationBar1DisplayOverlayIngameProcedure extends InstrumentalModElements.ModElement {
	public InspirationBar1DisplayOverlayIngameProcedure(InstrumentalModElements instance) {
		super(instance, 182);
	}
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				InstrumentalMod.LOGGER.warn("Failed to load dependency entity for procedure InspirationBar1DisplayOverlayIngame!");
			return false;
		}
		...
		if ((new Object() {
			...
			if (((ItemTags.getCollection().getTagByID(new ResourceLocation(("forge:instruments").toLowerCase(java.util.Locale.ENGLISH)))
					...
					&& ((((entity.getCapability(InstrumentalModVariables.PLAYER_VARIABLES_CAPABILITY, null)
							...
							&& (((entity.getCapability(InstrumentalModVariables.PLAYER_VARIABLES_CAPABILITY, null)
									.orElse(new InstrumentalModVariables.PlayerVariables())).Inspiration) < 2)))) {
				return (true);
			}
		}
		return (false);

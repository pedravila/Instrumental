...
public class OakTambourineRangedItemUsedProcedure extends InstrumentalModElements.ModElement {
	public OakTambourineRangedItemUsedProcedure(InstrumentalModElements instance) {
		super(instance, 206);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				InstrumentalMod.LOGGER.warn("Failed to load dependency entity for procedure OakTambourineRangedItemUsed!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				InstrumentalMod.LOGGER.warn("Failed to load dependency itemstack for procedure OakTambourineRangedItemUsed!");
			return;
		}

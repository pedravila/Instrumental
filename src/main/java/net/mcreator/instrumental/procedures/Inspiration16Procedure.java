...
public class Inspiration16Procedure extends InstrumentalModElements.ModElement {
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		...
		return ((16 == ((entity.getCapability(InstrumentalModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new InstrumentalModVariables.PlayerVariables())).Inspiration))
				|| (16 > ((entity.getCapability(InstrumentalModVariables.PLAYER_VARIABLES_CAPABILITY, null)
						.orElse(new InstrumentalModVariables.PlayerVariables())).Inspiration)));
	}
}

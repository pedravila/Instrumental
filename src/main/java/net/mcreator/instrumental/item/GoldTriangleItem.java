...
import net.mcreator.instrumental.entity.renderer.GoldTriangleRenderer;
...
public class GoldTriangleItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:gold_triangle")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletgold_triangle").setRegistryName("entitybulletgold_triangle");
	public GoldTriangleItem(InstrumentalModElements instance) {
		super(instance, 14);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GoldTriangleRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A72 4 Attack Damage"));
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (IronTriangleCanUseRangedItemProcedure.executeProcedure(ImmutableMap.of("entity", entity))) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.1f, 2, 0);
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("instrumental:triangle_sound")),

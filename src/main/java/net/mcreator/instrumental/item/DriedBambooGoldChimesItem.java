...
import net.mcreator.instrumental.entity.renderer.DriedBambooGoldChimesRenderer;
...
public class DriedBambooGoldChimesItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:dried_bamboo_gold_chimes")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletdried_bamboo_gold_chimes").setRegistryName("entitybulletdried_bamboo_gold_chimes");
	public DriedBambooGoldChimesItem(InstrumentalModElements instance) {
		super(instance, 18);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DriedBambooGoldChimesRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("dried_bamboo_gold_chimes");
		}

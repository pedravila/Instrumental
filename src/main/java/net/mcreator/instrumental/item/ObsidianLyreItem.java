...
import net.mcreator.instrumental.entity.renderer.ObsidianLyreRenderer;
...
public class ObsidianLyreItem extends InstrumentalModElements.ModElement {
	...
	public ObsidianLyreItem(InstrumentalModElements instance) {
		super(instance, 22);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ObsidianLyreRenderer.ModelRegisterHandler());
	}

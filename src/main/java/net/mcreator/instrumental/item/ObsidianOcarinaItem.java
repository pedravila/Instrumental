...
import net.mcreator.instrumental.entity.renderer.ObsidianOcarinaRenderer;
...
public class ObsidianOcarinaItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:obsidian_ocarina")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletobsidian_ocarina").setRegistryName("entitybulletobsidian_ocarina");
	public ObsidianOcarinaItem(InstrumentalModElements instance) {
		super(instance, 38);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ObsidianOcarinaRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("obsidian_ocarina");
		}

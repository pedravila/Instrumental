...
import net.mcreator.instrumental.entity.renderer.ObsidianClarinetRenderer;
...
public class ObsidianClarinetItem extends InstrumentalModElements.ModElement {
	...
	public ObsidianClarinetItem(InstrumentalModElements instance) {
		super(instance, 44);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ObsidianClarinetRenderer.ModelRegisterHandler());
	}

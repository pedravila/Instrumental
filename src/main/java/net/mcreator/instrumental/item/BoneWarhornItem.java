...
import net.mcreator.instrumental.procedures.BoneWarhornRightClickedInAirProcedure;
...
public class BoneWarhornItem extends InstrumentalModElements.ModElement {
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.getPosZ();
				{
					...
					BoneWarhornRightClickedInAirProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("bone_warhorn"));
	}

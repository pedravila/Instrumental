...
import net.mcreator.instrumental.entity.renderer.DriedBambooIronChimesRenderer;
...
public class DriedBambooIronChimesItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:dried_bamboo_iron_chimes")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletdried_bamboo_iron_chimes").setRegistryName("entitybulletdried_bamboo_iron_chimes");
	public DriedBambooIronChimesItem(InstrumentalModElements instance) {
		super(instance, 17);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DriedBambooIronChimesRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("dried_bamboo_iron_chimes");
		}

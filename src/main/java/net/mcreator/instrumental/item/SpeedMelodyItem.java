...
public class SpeedMelodyItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:speed_melody")
	public static final Item block = null;
	public SpeedMelodyItem(InstrumentalModElements instance) {
		super(instance, 108);
	}

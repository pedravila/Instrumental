...
import net.mcreator.instrumental.entity.renderer.ObsidianAccordionRenderer;
...
public class ObsidianAccordionItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:obsidian_accordion")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletobsidian_accordion").setRegistryName("entitybulletobsidian_accordion");
	public ObsidianAccordionItem(InstrumentalModElements instance) {
		super(instance, 36);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ObsidianAccordionRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("obsidian_accordion");
		}

...
import net.mcreator.instrumental.entity.renderer.ObsidianBerimbauRenderer;
...
public class ObsidianBerimbauItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:obsidian_berimbau")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletobsidian_berimbau").setRegistryName("entitybulletobsidian_berimbau");
	public ObsidianBerimbauItem(InstrumentalModElements instance) {
		super(instance, 42);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ObsidianBerimbauRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("obsidian_berimbau");
		}

...
public class LevitationScoreItem extends InstrumentalModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("levitation_score");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7c Levitate enemies"));

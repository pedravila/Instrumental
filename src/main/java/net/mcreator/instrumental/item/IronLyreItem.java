...
import net.mcreator.instrumental.entity.renderer.IronLyreRenderer;
...
public class IronLyreItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:iron_lyre")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletiron_lyre").setRegistryName("entitybulletiron_lyre");
	public IronLyreItem(InstrumentalModElements instance) {
		super(instance, 20);
		FMLJavaModLoadingContext.get().getModEventBus().register(new IronLyreRenderer.ModelRegisterHandler());
	}

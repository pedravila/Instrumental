...
import net.mcreator.instrumental.entity.renderer.ObsidianBanjoRenderer;
...
public class ObsidianBanjoItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:obsidian_banjo")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletobsidian_banjo").setRegistryName("entitybulletobsidian_banjo");
	public ObsidianBanjoItem(InstrumentalModElements instance) {
		super(instance, 30);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ObsidianBanjoRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("obsidian_banjo");
		}

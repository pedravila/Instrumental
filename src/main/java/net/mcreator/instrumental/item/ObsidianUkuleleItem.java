...
public class ObsidianUkuleleItem extends InstrumentalModElements.ModElement {
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.getPosZ();
				{
					...
					ObsidianUkuleleRightClickedInAirProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("obsidian_ukulele"));
	}

...
import net.mcreator.instrumental.entity.renderer.IronTriangleRenderer;
...
public class IronTriangleItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:iron_triangle")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletiron_triangle").setRegistryName("entitybulletiron_triangle");
	public IronTriangleItem(InstrumentalModElements instance) {
		super(instance, 13);
		FMLJavaModLoadingContext.get().getModEventBus().register(new IronTriangleRenderer.ModelRegisterHandler());
	}

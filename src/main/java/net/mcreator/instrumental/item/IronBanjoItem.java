...
import net.mcreator.instrumental.entity.renderer.IronBanjoRenderer;
...
public class IronBanjoItem extends InstrumentalModElements.ModElement {
	...
	public IronBanjoItem(InstrumentalModElements instance) {
		super(instance, 28);
		FMLJavaModLoadingContext.get().getModEventBus().register(new IronBanjoRenderer.ModelRegisterHandler());
	}

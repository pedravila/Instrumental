...
import net.mcreator.instrumental.entity.renderer.GoldLyreRenderer;
...
public class GoldLyreItem extends InstrumentalModElements.ModElement {
	...
	public GoldLyreItem(InstrumentalModElements instance) {
		super(instance, 21);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GoldLyreRenderer.ModelRegisterHandler());
	}

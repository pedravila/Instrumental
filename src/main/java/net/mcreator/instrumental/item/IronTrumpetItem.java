...
import net.mcreator.instrumental.entity.renderer.IronTrumpetRenderer;
...
public class IronTrumpetItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:iron_trumpet")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletiron_trumpet").setRegistryName("entitybulletiron_trumpet");
	public IronTrumpetItem(InstrumentalModElements instance) {
		super(instance, 15);
		FMLJavaModLoadingContext.get().getModEventBus().register(new IronTrumpetRenderer.ModelRegisterHandler());
	}

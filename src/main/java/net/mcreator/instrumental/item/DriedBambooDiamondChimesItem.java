...
public class DriedBambooDiamondChimesItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:dried_bamboo_diamond_chimes")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletdried_bamboo_diamond_chimes").setRegistryName("entitybulletdried_bamboo_diamond_chimes");
	public DriedBambooDiamondChimesItem(InstrumentalModElements instance) {
		super(instance, 19);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DriedBambooDiamondChimesRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A72 8 Attack Damage"));
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (DriedBambooDiamondChimesCanUseRangedItemProcedure.executeProcedure(ImmutableMap.of("entity", entity))) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.1f, 3.5, 0);
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						DriedBambooDiamondChimesRangedItemUsedProcedure.executeProcedure($_dependencies);
					}
				}
			}
		}
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("instrumental:dried_bamboo_chime_sound")),

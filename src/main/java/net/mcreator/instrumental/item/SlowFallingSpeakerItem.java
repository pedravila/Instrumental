...
public class SlowFallingSpeakerItem extends InstrumentalModElements.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A79 Slow Falling Effect"));
				list.add(new StringTextComponent("\u00A79 4 Inspiration"));
			}
		}.setRegistryName("slow_falling_speaker"));
	}

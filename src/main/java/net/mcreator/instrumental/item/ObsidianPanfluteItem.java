...
import net.mcreator.instrumental.entity.renderer.ObsidianPanfluteRenderer;
...
public class ObsidianPanfluteItem extends InstrumentalModElements.ModElement {
	@ObjectHolder("instrumental:obsidian_panflute")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletobsidian_panflute").setRegistryName("entitybulletobsidian_panflute");
	public ObsidianPanfluteItem(InstrumentalModElements instance) {
		super(instance, 40);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ObsidianPanfluteRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("obsidian_panflute");
		}

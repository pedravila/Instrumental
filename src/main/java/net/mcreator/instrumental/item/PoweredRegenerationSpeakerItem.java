...
public class PoweredRegenerationSpeakerItem extends InstrumentalModElements.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A79 Regeneration II Effect"));
				list.add(new StringTextComponent("\u00A79 4 Inspiration"));
			}
		}.setRegistryName("powered_regeneration_speaker"));
	}
